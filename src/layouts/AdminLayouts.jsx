...
import { Book, Briefcase, Building2, HandCoins, Menu, Newspaper, Plus, X } from "lucide-react";
...
const AdminLayouts = () => {
    ...
    const navLinks = [
        { name: "Course", path: "/admin-dashboard/course-management", icon: <Book size={16} /> },
        { name: "Enrollment Management", path: "/admin-dashboard/enrollment-management", icon: <FaGraduationCap size={16} /> },
